#!/usr/bin/env python3
"""
Minimal working example: low-rank continuation of FCI states.
- Hamiltonian-error truncation of the low-rank decomposition
...
print("-" * 72)
print("state     FCI ref (Ha)     Full EVCont (Ha)    Low-rank EVCont (Ha)")
print("-" * 72)
