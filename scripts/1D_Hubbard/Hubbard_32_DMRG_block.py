...
driver.bw.b.Global.threading.n_threads_global
...
bond_dims = [100]*5 + [250] * 10 + [500] * 10 + [1000 + i * 100 for i in range(20)]
noises = [1e-4] * 5 + [1e-5] * 10 + [1e-6] * 10 + [0]


en = driver.dmrg(mpo, ket, n_sweeps=1000, bond_dims=bond_dims, noises=noises, thrds=[1e-12]*45, iprint=1)
