...
"""
Single MD trajectory simulation with DFT (PBE exchange correlation function)
...
myintegrator = md.NVE(
    ...
    incore_anyway=True,
    frames=frames,
    trajectory_output="trajectory_PBE.xyz",
    data_output="energy_PBE.xyz",
    verbose=0,
)
myintegrator.run()
...
print(trajectory)
np.save("trajectory_PBE.npy", trajectory)
