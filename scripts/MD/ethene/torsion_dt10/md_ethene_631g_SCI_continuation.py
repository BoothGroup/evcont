...
# Build SCI continuation object for ground-state MD.
# parent_dir isolates SHCI and transition-RDM files for this run.
sci_cont = SCI_EVCont_obj(
    comp_mol=comp_mol,
    nroots=1,
    sweep_epsilon=1.0e-3,
    parent_dir="scimd_c2h4_631g",
)
